...
class Cell(aspose.words.CompositeNode):
    ...
    def __init__(self, doc: aspose.words.DocumentBase):
        ...
        To append :class:`Cell` to the document use Aspose.Words.CompositeNode.InsertAfter``1(``0,Aspose.Words.Node) or Aspose.Words.CompositeNode.InsertBefore``1(``0,Aspose.Words.Node)
...
class Row(aspose.words.CompositeNode):
    ...
    def __init__(self, doc: aspose.words.DocumentBase):
        ...
        To append :class:`Row` to the document use Aspose.Words.CompositeNode.InsertAfter``1(``0,Aspose.Words.Node) or Aspose.Words.CompositeNode.InsertBefore``1(``0,Aspose.Words.Node)
...
class Table(aspose.words.CompositeNode):
    ...
    def __init__(self, doc: aspose.words.DocumentBase):
        ...
        To append :class:`Table` to the document use Aspose.Words.CompositeNode.InsertAfter``1(``0,Aspose.Words.Node) or Aspose.Words.CompositeNode.InsertBefore``1(``0,Aspose.Words.Node)
