...
class Footnote(aspose.words.InlineStory):
    ...
    def __init__(self, doc: aspose.words.DocumentBase, footnote_type: aspose.words.notes.FootnoteType):
        ...
        To append :class:`Footnote` to the document use Aspose.Words.CompositeNode.InsertAfter``1(``0,Aspose.Words.Node) or Aspose.Words.CompositeNode.InsertBefore``1(``0,Aspose.Words.Node)
